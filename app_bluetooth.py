...
def conectar_bluetooth():
    ...
    try:
        ...
        print("No se pudo conectar Bluetooth:", e)
        bt_sock = None
...
<body style="text-align:center; font-family:Arial;">
    ...
    <audio id="alarma" src="/audio" preload="auto"></audio>

    <img src="/video"
         style="width:800px; max-width:95%; border-radius:15px; border:3px solid #7b2cbf;">
...
@app.route("/audio")
def audio():
    return open("levantense.mp3", "rb").read(), 200, {"Content-Type": "audio/mpeg"}
...
@app.route("/estado")
def estado():
    return jsonify({"alerta": alerta_web})
